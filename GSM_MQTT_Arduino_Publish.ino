...
void GSM_MQTT::AutoConnect(void)
{
  ...
  */
//  connect("qwertyuiop", 1, 1, "beHive", "beHive@123$", 1, 0, 0, 0, "", "");
  ...
  */
    Serial.println("MQTT AutoConnect done");
}
  ...
  */
  ...
  /*    void subscribe(char DUP, unsigned int MessageID, char *SubTopic, char SubQoS);
          ...
          SubQoS    :QoS level at which the client wants to receive messages
                    ...
                    :Default value 0
  */
publish(0, 0, 0, _generateMessageID(), "SampleTopic", "HiShadab");
  ...
  */
  if (MQTT.available())
  {
    /*
      ...
      You can write your code here
    */
    Serial.println("Now MQTT Available");
    MQTT.OnConnect();
  }
